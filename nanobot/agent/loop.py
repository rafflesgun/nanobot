...
class AgentLoop:
    ...
    def _turn_route(msg: InboundMessage, session_key: str) -> TurnRoute:
        ...
        # Preserve Telegram topic routing for system messages (e.g. subagent
        # announces) so the outbound reply lands in the originating topic.
    ...
    async def _state_restore(self, ctx: TurnContext) -> TurnState:
        ...
        if ctx.kind is TurnKind.USER and msg.media and isinstance(msg.media, list):
