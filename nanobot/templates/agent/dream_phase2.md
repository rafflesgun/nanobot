...
- [SKILL] entries: create a proposal under memory/skill-proposals/<name>.md using write_file

## File paths (relative to workspace root)
- SOUL.md
- USER.md
- memory/MEMORY.md
- memory/skill-proposals/<name>.md (for [SKILL] entries only)
...
- Use write_file to create memory/skill-proposals/<name>.md
...
- Do NOT write directly under skills/
- Do NOT overwrite existing installed skills or existing proposal files — skip if they already exist
